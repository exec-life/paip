...
(defun achieve-all (gaols) "Try to achieve each goal, then make sure they still hold."
...
(defun apply-op (op)
  ...
  (when (every #'achieve-all (op-preconds op))
...
(defvar *dbg-ids* nil "Identifier used by dbg")
